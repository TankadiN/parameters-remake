...
public class DiscordManager : MonoBehaviour {
    ...
    /*public DiscordPresence UpdateButton(DiscordButton button)
    {
        if (_client == null) return null;
        if (button == null) return (DiscordPresence)_client.UpdateButton("", "");
        return (DiscordPresence)_client.UpdateButton(button.label, button.url);
    }*/
